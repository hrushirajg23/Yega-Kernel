...
/* Software flags */
#define PG_FLAG__LOCKED 1<<0
#define PG_FLAG__referenced 1<<1
#define PG_FLAG__dirty 1<<2
#define PG_FLAG__lru 1<<3
#define PG_FLAG__private 1<<4
#define PG_FLAG__reclaim 1<<5
#define PG_TAKEN 1<<6
